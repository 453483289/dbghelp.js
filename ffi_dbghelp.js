...
if ( arch_x64 )
{
    lib_dbghelp = ffi.DynamicLibrary( path.resolve( __filename, '../bin/amd64/dbghelp.dll') );
}
else
{
    lib_dbghelp = ffi.DynamicLibrary( path.resolve( __filename, '../bin/i386/dbghelp.dll') );
}
